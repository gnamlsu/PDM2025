...
function setup() {
  ...
  character1.addAnimation("left", new SpriteAnimation(sprite1, 0, 0, 9));
  character1.addAnimation("right", new SpriteAnimation(sprite1, 0, 0, 9));
  ...
  character2.addAnimation("left", new SpriteAnimation(sprite2, 0, 0, 9));
  character2.addAnimation("right", new SpriteAnimation(sprite2, 0, 0, 9));
  ...
  character3.addAnimation("left", new SpriteAnimation(sprite3, 0, 0, 9));
  character3.addAnimation("right", new SpriteAnimation(sprite3, 0, 0, 9));
